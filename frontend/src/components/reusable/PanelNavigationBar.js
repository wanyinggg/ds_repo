...
const pages = [
  { label: "Presentation Timeslot", path: "/panelpresentation" },
  { label: "Evaluation", path: "/panelevaluation" }, 
];


function PanelNavigationBar() {
  const [anchorElNav, setAnchorElNav] = React.useState(null);
  const [anchorElUser, setAnchorElUser] = React.useState(null);
  const [userRole, setUserRole] = React.useState("panel");
...
export default PanelNavigationBar;
